...
This directory contains a Kubernetes chart to deploy a seven node Citus cluster using a StatefulSet.
...
* Implement a sharded PostgreSQL cluster using Kubernetes StatefulSets
